...
def audio_callback(outdata, frames, time_info, status):
    ...
    with lock:
        ...
        for snd, pos in active_sounds:
            remaining = len(snd) - pos
            chunk = snd[pos:pos+frames]

            buffer[:len(chunk)] += chunk * volume
...
def main():
    ...
    conf = {"output_device": None, "volume": 0.8}
    ...
    print("🟢 READY — spam keys like a maniac")
